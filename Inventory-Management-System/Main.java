...
public class Main 
{
    ...
    private static void displayMainMenu() 
    {
        ...
        System.out.println("6. Out-of-Stock Report");
    ...
    private static void reportsMenu() {
        ...
        while (!back) {
            ...
            System.out.println("2. Inventory Value Report");
            System.out.println("3. Low Stock Report (Limit 5)");
            System.out.println("4. Out-of-Stock Report");
            System.out.println("5. Back");

            int choice = readInt("Enter your choice: ");
            switch (choice) {
                case 1:
                    System.out.println("\nProducts: " + manager.getProductCount());
                    System.out.println("Categories: " + manager.getCategoryCount());
                    System.out.println("Total units in stock: " + manager.getTotalUnits());
                    System.out.printf("Total inventory value: %.2f%n", manager.calculateTotalInventoryValue());
                    break;
                case 2:
                    manager.displayMostValuableProducts();
                    break;
                case 3:
                    manager.displayLowStock(5);
                    break;
    ...
    private static void searchByCategory() {
        System.out.println("\n----------- SEARCH BY CATEGORY -----------");
        String category = readString("Enter category name: ");
